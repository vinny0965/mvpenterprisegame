                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<QuizRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<QuizRecord> textQuizRecordList = snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final textQuizRecord = textQuizRecordList.isNotEmpty
                            ? textQuizRecordList.first
                            : null;
                        return Text(
                          valueOrDefault<String>(
                            textQuizRecord?.question,
                            'question',
                          ),
                          style:
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          if (home07InvoicesQuizRecordList[0]
                                              .hasId()) {
                                            setState(() {
                                              FFAppState().alternativaCorreta =
                                                  true;
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          16.0, 12.0, 16.0, 0.0),
                                      child:
                                          StreamBuilder<List<QuestaoCRecord>>(
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          16.0, 12.0, 16.0, 0.0),
                                      child:
                                          StreamBuilder<List<QuestaoDRecord>>(
