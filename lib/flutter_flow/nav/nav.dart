...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const Onboarding04Widget() : const Auth2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => HomePageCopyWidget(
            treinamentos: params.getParam('treinamentos',
                ParamType.DocumentReference, false, ['treinamentos']),
          ),
        ),
        FFRoute(
          name: 'Home03Coffee',
          path: '/home03Coffee',
          builder: (context, params) => const Home03CoffeeWidget(),
        ),
        FFRoute(
          name: 'Details01YogaClass',
          path: '/details01YogaClass',
          builder: (context, params) => Details01YogaClassWidget(
            paginaTreinamento: params.getParam('paginaTreinamento',
                ParamType.DocumentReference, false, ['treinamentos']),
          ),
        ),
        FFRoute(
